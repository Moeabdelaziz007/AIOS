...
import { aiosTheme, appCategoryColors, statusColors, commonStyles, animations } from '../theme/aiosTheme';
  ...
  return (
    <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
        ...
        <Box display="flex" justifyContent="space-between" alignItems="center">
          <Box>
            ...
            <Typography variant="h6" sx={{ opacity: 0.9 }}>
              مرحباً {userProfile?.displayName || 'المستخدم'}، اختر التطبيق الذي تريد استخدامه
            </Typography>
      ...
      <Grid container spacing={3} sx={{ mb: 4 }}>
        {defaultApps.filter(app => app.featured).map((app, index) => (
              ...
              >
                ...
                <CardActions sx={{ position: 'relative', zIndex: 1 }}>
                  <Button
                    ...
                    disabled={app.status === 'inactive' || app.status === 'error'}
                    sx={{ 
                      color: 'white', 
      ...
      <Box mt={4} textAlign="center">
        <Typography variant="body2" color="text.secondary">
          إجمالي التطبيقات: {defaultApps.length} | المستخدم: {userProfile?.role || 'غير محدد'}
        </Typography>
      </Box>
    </Container>
  );
